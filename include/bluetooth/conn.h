 ...
 *    Timeout: 4 s
 */
#define BT_LE_CONN_PARAM_DEFAULT3 BT_LE_CONN_PARAM(BT_GAP_INIT_CONN_INT_MIN/4, \
						  BT_GAP_INIT_CONN_INT_MAX/4, \
						  0, 400)
//#define BT_LE_CONN_PARAM_DEFAULT3 BT_LE_CONN_PARAM(0x00e8, 0x00e8,0, 400)
#define BT_LE_CONN_PARAM_DEFAULT2 BT_LE_CONN_PARAM(BT_GAP_INIT_CONN_INT_MIN*2, \
						  BT_GAP_INIT_CONN_INT_MAX*2, \
						  0, 400)
#define BT_LE_CONN_PARAM_DEFAULT BT_LE_CONN_PARAM(BT_GAP_INIT_CONN_INT_MIN*1, \
						  BT_GAP_INIT_CONN_INT_MAX*1, \
						  0, 400)
